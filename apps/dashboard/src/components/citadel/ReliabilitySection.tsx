...
export function ReliabilitySection({ fleetId, authKey }: ReliabilitySectionProps) {
    ...
    <div style={{ padding: 24 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <h2 style={{ fontFamily: FONT_DISPLAY, fontSize: 18, fontWeight: 700, color: 'var(--tx)', margin: 0 }}>
            {view === 'index' ? 'Reliability' : view === 'agent' ? selectedAgent : 'Evidence'}
          </h2>
        </div>
