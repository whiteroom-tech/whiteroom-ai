...
export function StatBox({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div style={{ borderRadius: 4, textAlign: 'center', padding: '4px 6px', background: 'var(--sunk, #050810)', border: '1px solid var(--line, #0f172a)' }}>
      <div style={{ fontSize: 9, letterSpacing: 0.5, marginBottom: 2, color: 'var(--tx3, #475569)' }}>{label}</div>
